...
добавить галочку с сохранением своего цвета волос. Эта галочка будет влиять на промпт.
и добавить кнопку повернуть на 3/4
в историю не сохранять полный урл так как он может измениться. Сохраняем толькко то чо после домена идет
Делиться не только конкретной фотой но и группами по 3 фото (так удобнее смотреть: твоя фотка, фотка прически и результат)
Добавить возможность если на загружаемой фотке человек смотрит вбок то чтобы он смотрел прямо сделать

Хотя в png тоже работает. преобразование в jpg добавить в параметр вынести возможно по умолчанию не нужно чтобы совместимость осталась.
добавить урл фронта в cors

если неудачно получилось. Кнопка еще раз и используется другаяя нейронка

важно чтобы фронтовая фотка была (не сбоку или сзади)
